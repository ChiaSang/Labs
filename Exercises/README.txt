The 'data' directory contains AS relationships inferred using the method
...
<peer-as>|<peer-as>|0
Sibling relationships can be inferred using CAIDA's AS-to-organisation
files, available at <brad>.

The ppdc files contain the provider-peer customer cones inferred for
each AS.  Each line specifies an AS an all ASes we infer to be reachable
